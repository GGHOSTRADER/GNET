...
GNET continuously engineers features from TradeStation bars and ticks. A primary-strategy candidate triggers the mapped model, and an approve/reject decision matched to the exact candidate returns to the originating strategy window.
